...
public class BranchManagerController {
	...
	public ResponseEntity<ResponseStructure<BranchManager>> login(@RequestBody BranchManager branchManager){
		return service.findByEmailAndPassword(branchManager);
	}
